...
- `MUST-006`: Next.js route handlers MUST NOT contain business logic beyond request/response mapping.
- `MUST-007`: TypeScript types for shared contracts MUST be generated from Rust source (no manual duplication).
- `MUST-008`: API contracts MUST have OpenAPI spec and contract tests.
