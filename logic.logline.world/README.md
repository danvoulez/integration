...
logline cicd run --pipeline integration-severe # Smoke+contracts+severe suite + report
...
- Optional observability mirror for runtime checkpoints:
  - `OBS_API_BASE_URL=https://obs-api.logline.world`
  - `OBS_API_TOKEN=<service token>`
